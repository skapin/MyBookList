...
de laisser un court message (140 caractères) en laissant vos coordonnées (e-mail, facebook, twitter, chat etc...).<br /><br /><br />
...
<div class="form-group">
  <label class="sr-only col-md-1 control-label" for="autre"></label>
    <div class="input-group">
      ...
      <textarea id="autre" name="autre" class="form-control" onkeyup="javascript:MaxLengthTextarea(this, 140);" ></textarea>  
  </div>
</div>';
...
$str .= '<div class="form-group">
    <button id="addWish" type="submit" name="askLivre" class="btn btn-success">Ajouter</button>
  </div>
  </form>
</article>';
